            ...
            <div class="card border-0 shadow-sm rounded-5 overflow-hidden bg-white mb-5">
                <div class="card-body p-5">
                    <ul class="nav nav-tabs border-0 gap-4 mb-4" id="productTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <button class="nav-link active border-0 fw-bold px-0 text-dark" data-bs-toggle="tab" data-bs-target="#spec" type="button">THÔNG SỐ KỸ THUẬT</button>
                        </li>
                    </ul>
    ...
    <style>
        /* Tabs sản phẩm */
#productTab .nav-link {
    color: #111 !important;           /* chữ đậm rõ */
    font-weight: 700;
    font-size: 16px;
